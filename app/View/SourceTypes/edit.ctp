...
<?php echo $this->Form->create('SourceType'); ?>
	<fieldset>
		<legend><?php echo __('Edit Source Type'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SourceType.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SourceType.id'))); ?></li>
