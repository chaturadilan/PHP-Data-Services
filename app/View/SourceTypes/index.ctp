<div class="sourceTypes index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('init_params'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($sourceType['SourceType']['init_params']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $sourceType['SourceType']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $sourceType['SourceType']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $sourceType['SourceType']['id']), null, __('Are you sure you want to delete # %s?', $sourceType['SourceType']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
