...
<?php echo $this->Form->create('DataCollection'); ?>
	<fieldset>
		<legend><?php echo __('Edit Data Collection'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('DataCollection.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('DataCollection.id'))); ?></li>
