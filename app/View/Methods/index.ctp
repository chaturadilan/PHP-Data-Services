<div class="methods index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('data_collections_id'); ?></th>
			<th><?php echo $this->Paginator->sort('method_type_id'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($method['Method']['command']); ?>&nbsp;</td>
		<td><?php echo h($method['Method']['http_methods']); ?>&nbsp;</td>
		<td>
