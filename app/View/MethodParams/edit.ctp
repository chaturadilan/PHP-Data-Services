...
<?php echo $this->Form->create('MethodParam'); ?>
	<fieldset>
		<legend><?php echo __('Edit Method Param'); ?></legend>
	<?php
		...
		echo $this->Form->input('methods_id');
	?>
	</fieldset>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MethodParam.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('MethodParam.id'))); ?></li>
